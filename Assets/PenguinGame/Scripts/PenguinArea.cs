...
public class PenguinArea : MonoBehaviour
{
    ...
    /// <summary>
    /// Remove a specific fish from the area when its eaten.
    /// </summary>
    ...
    /// <summary>
    /// Choose a random position on the X-Z plane with a partial donut shape
    /// </summary>
    ...
    /// <summary>
    /// Spawn some number of fish in the area and set the speed of fish
    /// </summary>
    /// <param name="count">The number of spawn</param>
    /// <param name="fishSpeed">The swim spped</param>
    private void SpawnFish(int count, float fishSpeed)
    {
        for (int i = 0; i < count; i++)
        {
            ...
            //Set the fish's parent to teh area's transform
